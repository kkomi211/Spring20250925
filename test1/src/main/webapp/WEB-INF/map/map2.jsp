        ...
        const app = Vue.createApp({
            ...
            methods: {
                ...
                displayPlaceInfo(place) {
                    ...
                    this.placeOverlay.setMap(this.map); // ← 요청하신 대로 this. 사용
                },
            ...
            mounted() {
                ...
                // 지도 이벤트와 오버레이 컨텐츠 이벤트 보호
                kakao.maps.event.addListener(this.map, 'idle', this.searchPlaces.bind(this));
